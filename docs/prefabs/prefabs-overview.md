...
A prefab is basically just a chunk of a level. It contains game objects (entities / nodes) with components. For example a *box prefab* would contain a single game object, a [mesh component](../graphics/meshes/mesh-component.md), a [physics actor component](../physics/actors/physx-actors.md) and a [physics box shape (TODO)](../physics/collision-shapes/physx-shapes.md). Together these make up an object that looks like a box and behaves like a box.
